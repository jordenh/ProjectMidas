...
#define DEFAULT_OVERRIDE_ANG_SENSE true
...
#define BATTERY_WIDGET_HEIGHT 150
#define BATTERY_WIDGET_WIDTH 400

#define LOW_SIGNAL_THRESHOLD 25
#define HIGH_SIGNAL_THRESHOLD 75
#define LOW_BATTERY_THRESHOLD 30
#define SIGNAL_STRENGTH_BINS 4
